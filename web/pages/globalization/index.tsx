...
import { DesignGlobalizationRepository, DesignGlobalizationRepositoriesStore } from "@bridged.xyz/client-sdk/lib/g11n/repository"
...
export default function Home() {
  ...
  const [desingGlobalizationRepository, setdesingGlobalizationRepository] = useState<DesignGlobalizationRepository>()
  ...
  useEffect(() => {
    if (sceneId && !sceneRepository) {
      ...
      service.fetchScene(sceneId).then((response) => {
        ...
        const desingGlobalizationRepository = DesignGlobalizationRepositoriesStore.make('temp', scene.id!)
